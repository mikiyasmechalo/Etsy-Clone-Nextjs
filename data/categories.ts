// import { Product } from "@/app/c/[id]/page";
  ...
  export const categoryData: categoryDataProps[] = [
    {
      ...
      featuredProducts: [
        {
          "id": 1,
          "title": "Personalized Initial Heart Keychain Set, Initials Couple Keychain",
          "description": "A lovely heart-shaped keychain set personalized with initials, perfect for couples.",
          "price": 9.08,
          "originalPrice": 18.17,
          "images": ["/hat.jpg"],
        ...
        {
          "id": 2,
          "title": "Custom Name Keychain, Personalized Keychain, Gift for Her, Gift for Him",
          "description": "A custom name keychain, an ideal personalized gift for any occasion.",
          "price": 12.99,
          "originalPrice": 19.99,
          "images": ["/hat.jpg"],
        ...
        {
          "id": 3,
          "title": "Leather Keychain with Initial, Monogram Keyring, Personalized Gift",
          "description": "Elegant leather keychain featuring monogrammed initials, a thoughtful gift option.",
          "price": 15.5,
          "images": ["/earings.jpg"],
        ...
        },
        {
          ...
          "description": "A mini macrame keychain with boho charm, perfect for bags and cars.",
          "price": 8.25,
          "originalPrice": 11.0,
          "images": ["/earings.jpg"],
        ...
        },
        {
          ...
          "description": "Beautiful resin keychain with dried flowers, inspired by nature.",
          "price": 14.95,
          "images": ["/hat.jpg"],
        ...
        },
        {
          ...
          "description": "Engraved wooden name keychain, a timeless and customizable gift.",
          "price": 10.5,
          "originalPrice": 15.0,
          "images": ["/hat.jpg"],
      ...
      featuredProducts: [
        {
          ...
          "description": "A dainty gold necklace with a minimalist design, perfect for everyday wear or special occasions.",
          "price": 24.99,
          "originalPrice": 39.99,
        ...
        },
        {
          ...
          "description": "A personalized bracelet with birthstones, an ideal and thoughtful gift for her.",
          "price": 18.75,
          "originalPrice": 25.0,
          "images": ["/placeholder.svg?height=200&width=200"],
          "quantityAvailable": 150,
